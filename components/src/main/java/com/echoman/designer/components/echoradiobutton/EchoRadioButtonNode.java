...
import com.echoman.designer.components.echocommon.ItemValueEditor;
import com.echoman.designer.components.echocommon.LayoutPropertyEditor;
 ...
 * @author Dave Athlon
 */
public class EchoRadioButtonNode extends EchoBaseNode {
    /**
     * 
     * @param o
     */
    public EchoRadioButtonNode(EchoRadioButtonNodeData o) {
    	super(o);
        setName("RadioButton" + o.getIndex());
    }
    ...
    protected Sheet createSheet() {
        ...
        try {
            ...
            registerProperty(new PropInfo("Button Layout", String.class, "buttonLayout", null, null, LayoutPropertyEditor.class, null), set);
            ...
            registerProperty(new PropInfo("Items", String.class, "items", null, null, ItemValueEditor.class, null), set);
            ...
            registerProperty(new PropInfo("Selected Value", String.class, "selectedValue"), set);
            registerProperty(new PropInfo("Allow No Selection", boolean.class, "allowNoSelection"), set);
            ...
            EchoUtil.showNotification("Properties", "[EchoRadioButtonNode] CreateSheet error. " + ex.toString());
        }
    ...
    public String getNodeDisplayName() {
        return nodeData.getIndex() + " - " + ((EchoRadioButtonNodeData)nodeData).getColumn();
    }
}
